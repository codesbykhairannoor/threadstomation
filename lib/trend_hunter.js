...
CRITICAL HARD-SELLING DIRECTIVE (FOR TRANVAS & SHARESA SPACE):
- If the account is Tranvas or Sharesa Space: You MUST bridge the trending topic into a high-converting PAIN-GAIN-SOLUTION narrative.
  - Do NOT write boring, academic commentary.
  - Connect the news/trend to the user's PAIN (chaos, app fatigue, lost money, vulnerable platform reliance).
  - Reveal the GAIN (clarity, automation, 100% owned assets).
  - HARD SELL the product (Tranvas Life-OS Blueprint or Sharesa Space Web Development) as THE ultimate antidote, ending with a direct CTA to the link in bio!

OUTPUT FORMAT (JSON ONLY, NO MARKDOWN):
{
  "trending_keyword": "The exact keyword from the list",
  "newsjacked_prompt": "A sharp, high-urgency prompt instructing what angle to take for a SHORT, PUNCHY 2-4 post thread (MAX 4 posts). Hook on Pain Point -> Agitate -> Gain -> Hard Sell Solution with CTA in bio. Strictly 2-4 posts!"
}
`;
