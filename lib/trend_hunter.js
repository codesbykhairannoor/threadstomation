...
OUTPUT FORMAT (JSON ONLY, NO MARKDOWN):
{
  ...
  "newsjacked_prompt": "A sharp, high-urgency prompt instructing what angle to take for a SHORT, PUNCHY 2-4 post thread (MAX 4 posts). Focus on 1 thumb-stopping hook, 1-2 quick insights, and 1 discussion question. NEVER instruct a long thread."
}
`;
