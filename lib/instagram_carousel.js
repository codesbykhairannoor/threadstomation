...
export async function generateInstagramSlideImages(slides, customPalette = null, accountName = "@sharesa.space") {
  ...
  // Dynamic dark palettes — ALWAYS dark background, never bright/neon bg
  const palettes = [
    { bg1: '#042f2e', bg2: '#042f2e', accent: '#00ff8c', text: '#ffffff' }, // Original dark teal (same as 7 hours ago)
    { bg1: '#0f2027', bg2: '#0f2027', accent: '#fde047', text: '#ffffff' }, // Deep teal + Gold
    { bg1: '#1a1a2e', bg2: '#1a1a2e', accent: '#e94560', text: '#ffffff' }, // Deep navy + Red
    { bg1: '#0a1628', bg2: '#0a1628', accent: '#f7971e', text: '#ffffff' }, // Midnight blue + Orange
    { bg1: '#1e2a39', bg2: '#1e2a39', accent: '#00ff8c', text: '#ffffff' }, // Charcoal + Neon green
  ];
