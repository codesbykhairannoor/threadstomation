...
`;
  ...
  // Varied topic rotation for Adhlil when no specific custom prompt is given
  const adhlilTopicAngles = [
    'Ketenangan batin & cara mengatasi overthinking serta cemas masa depan',
    'Manajemen waktu, fokus, dan produktivitas harian ala Rasulullah SAW',
    'Kekuatan istiqomah (hukum 1%) dalam amalan kecil yang berdampak besar',
    'Menghadapi kegagalan, rasa lelah, dan konsep tawakkal yang melegakan',
    'Adab menjaga hati & ketenangan pikiran di tengah distraksi digital',
    'Mindset syukur, rahasia berkah, dan kelapangan rezeki',
    'Hikmah kisah sahabat Nabi tentang kesabaran dalam proses hidup',
    'Dzikir dan kebiasaan pagi untuk memulai hari dengan energi positif'
  ];
