...
OUTPUT FORMAT (strict JSON, no markdown):
{
  "slides": [
    { 
      ...
      "foreground_subject_prompt": "A detailed english prompt for a single isolated object/person. E.g. 'A professional asian businessman smiling, isolated on white background' or 'A sleek modern laptop displaying a dashboard'. If layout_type is 'TextHeavy', leave this empty.",
