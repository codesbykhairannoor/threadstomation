...
OUTPUT FORMAT (strict JSON, no markdown):
{
  "slides": [
    { 
      "layout_type": "Choose one: 'CenterMockup', 'LeftPerson', 'RightPerson', 'TextHeavy'",
      "title_part1": "First part of the slide title. E.g. 'Website Kamu'", 
      "title_part2": "The punchy HIGHLIGHT word/phrase (max 1-3 words). This will be drawn with a high-contrast background (like a marker). E.g. 'Masih Lemot?'", 
      "body": "Optional body text. Keep it VERY short, max 1 sentence or empty string.",
      "foreground_subject_prompt": "A detailed english prompt for a single isolated object/person. E.g. 'A professional asian businessman smiling, isolated on a solid dark gray background' or 'A sleek modern laptop displaying a dashboard, solid black background'. ALWAYS request a solid dark background. If layout_type is 'TextHeavy', leave this empty.",
