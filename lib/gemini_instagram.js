...
${isOneformind || isCaridisini ? "- BRAND RULE: The cover slide (Slide 1) MUST NOT use the 'TextHeavy' layout type. It MUST use an image-based layout (CenterMockup, TopMockup, LeftPerson, or RightPerson) with a high-quality foreground image prompt to act as an eye-catching cover." : ""}
${recentTopicsSection}
...
- DYNAMIC LANGUAGE & TONE (CRITICAL): ${isOneformind || isCaridisini ? 'You MUST output 100% of the content in ENGLISH. No exceptions.' : 'Analyze the language of the persona/master prompt above. If it is in English, you MUST output 100% of the content in English. If it is in Indonesian, output in Indonesian. The tone must be perfectly aligned with the persona. If no persona is provided, default to a smart, engaging, casual tone.'}
