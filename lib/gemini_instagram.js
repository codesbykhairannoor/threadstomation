...
OUTPUT FORMAT (strict JSON, no markdown):
{
  "slides": [
    { 
      ...
      "foreground_subject_prompt": "A detailed english prompt for a single isolated object/person. E.g. 'A professional asian businessman smiling, isolated on pure white background' or 'A sleek modern laptop displaying a dashboard, isolated on pure white background'. VERY IMPORTANT: Do NOT include any instructions for text. The image must have NO TEXT, NO WORDS, NO LETTERS. If layout_type is 'TextHeavy', leave this empty.",
