...
export async function renderSlideToBuffer(slide, foregroundBuffer, theme, badgeText) {
  ...
  const scribbles = [
    watermarkText,
    // Bold accent line
    { type: 'div', props: { style: { position: 'absolute', top: '220px', left: layout === 'RightPerson' ? '70px' : 'auto', right: layout === 'LeftPerson' ? '70px' : 'auto', width: '80px', height: '6px', background: accentColor, borderRadius: '3px' } } },
    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...bgOrbs,
          ...scribbles,
          // Foreground Object (Left Side) - Grounded Arch Crop (Anchored to bottom)
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '50px', bottom: '0px', display: 'flex', borderRadius: '250px 250px 0 0', overflow: 'hidden', borderTop: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderLeft: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderRight: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 -10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '500px', height: '800px', objectFit: 'cover' } } }
              ]
            } 
          },
          headerBadge,
    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...bgOrbs,
          ...scribbles,
          // Foreground Object (Right Side) - Grounded Arch
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', right: '50px', bottom: '0px', display: 'flex', borderRadius: '250px 250px 0 0', overflow: 'hidden', borderTop: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderLeft: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderRight: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 -10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '500px', height: '800px', objectFit: 'cover' } } }
              ]
            } 
    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...bgOrbs,
          ...scribbles,
          // Foreground Object (Top Center) - Inverse Grounded Arch
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', top: '0px', display: 'flex', borderRadius: '0 0 425px 425px', overflow: 'hidden', borderBottom: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderLeft: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderRight: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 20px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '850px', height: '600px', objectFit: 'cover' } } }
              ]
            } 
          },
          headerBadge,
    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...bgOrbs,
          ...scribbles,
          // Foreground Object (Bottom Center) - Grounded Wide Arch
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', bottom: '0px', display: 'flex', borderRadius: '425px 425px 0 0', overflow: 'hidden', borderTop: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderLeft: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderRight: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 -10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '850px', height: '600px', objectFit: 'cover' } } }
              ]
            } 
