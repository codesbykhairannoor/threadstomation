    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...
          headerBadge,
          footerBadge,
          // Text Content (Right Side) - Adjusted width to 450px to prevent overlap
          {
            type: 'div',
            props: {
              style: { position: 'absolute', right: '60px', top: '280px', width: '450px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' },
              children: [
