      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '50px', top: '225px', width: '500px', height: '900px', display: 'flex', borderRadius: '250px', overflow: 'hidden', border: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', right: '50px', top: '225px', width: '500px', height: '900px', display: 'flex', borderRadius: '250px', overflow: 'hidden', border: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '500px', height: '900px', objectFit: 'cover' } } }
              ]
            } 
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', bottom: '0px', width: '850px', height: '600px', display: 'flex', borderRadius: '425px 425px 0 0', overflow: 'hidden', borderTop: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderLeft: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', borderRight: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 -10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '850px', height: '600px', objectFit: 'cover' } } }
              ]
            } 
