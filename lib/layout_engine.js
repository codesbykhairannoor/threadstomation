      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', top: '150px', width: '850px', height: '550px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
          ...
          // Text Content (Bottom Center)
          {
            type: 'div',
            props: {
              style: { position: 'absolute', bottom: '180px', left: '100px', width: '880px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' },
              children: [
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', bottom: '130px', width: '850px', height: '550px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: isLightBg ? '2px solid rgba(0,0,0,0.05)' : '2px solid rgba(255,255,255,0.1)', boxShadow: isLightBg ? 'none' : '0 10px 50px rgba(0,0,0,0.5)', background: isLightBg ? '#fcfcfc' : 'rgba(255,255,255,0.02)' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '850px', height: '550px', objectFit: 'cover' } } }
              ]
            } 
