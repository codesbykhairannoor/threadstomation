      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '140px', top: '150px', width: '800px', height: '500px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: '#fcfcfc' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '800px', height: '500px', objectFit: 'cover' } } }
              ]
            } 
          },
          headerBadge,
          ...
          // Text Content (Bottom Center)
          {
            type: 'div',
            props: {
              style: { position: 'absolute', bottom: '130px', left: '140px', width: '800px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' },
              children: [
                topPillBadge,
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '140px', bottom: '130px', width: '800px', height: '500px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: '#fcfcfc' },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '800px', height: '500px', objectFit: 'cover' } } }
              ]
            } 
          ...
          // Text Content (Top Center)
          {
            type: 'div',
            props: {
              style: { position: 'absolute', top: '190px', left: '140px', width: '800px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' },
              children: [
                topPillBadge,
                { type: 'span', props: { style: { color: mainTextColor, fontSize: '84px', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-2px' }, children: slide.title_part1 || '' } },
                { type: 'span', props: { style: { color: accentColor, fontSize: '84px', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-2px', marginTop: '5px' }, children: slide.title_part2 || '' } },
