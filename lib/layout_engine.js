    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...
          { type: 'img', props: { src: fgBase64, style: { position: 'absolute', bottom: '60px', left: '40px', width: '1000px', height: '800px', objectFit: 'contain' } } },
          ...
          // Text Content (Top Center)
          {
            type: 'div',
            props: {
              style: { position: 'absolute', top: '190px', left: '70px', width: '940px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' },
              children: [
                ...
                highlightTitle,
                slide.body ? { type: 'div', props: { style: { marginTop: '40px', padding: '10px 20px', color: mainTextColor, fontSize: '36px', fontWeight: 500, lineHeight: 1.5, maxWidth: '850px', opacity: 0.9 }, children: slide.body } } : null
              ]
            }
          },
          bottomRibbon
    ...
    vdom = {
      ...
      props: {
        ...
        children: [
          ...
          { type: 'img', props: { src: fgBase64, style: { position: 'absolute', bottom: '60px', right: '-80px', width: '750px', height: '950px', objectFit: 'contain' } } },
          ...
          // Text Content (Left Side)
          {
            type: 'div',
            props: {
              style: { position: 'absolute', left: '90px', top: '280px', width: '580px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' },
              children: [
                { type: 'span', props: { style: { color: mainTextColor, fontSize: '84px', fontWeight: 900, lineHeight: 1.1, letterSpacing: '-3px' }, children: slide.title_part1 || '' } },
                highlightTitle,
                slide.body ? { type: 'div', props: { style: { marginTop: '50px', color: mainTextColor, fontSize: '36px', fontWeight: 500, lineHeight: 1.5, borderLeft: `6px solid ${accentColor}`, paddingLeft: '24px', opacity: 0.9 }, children: slide.body } } : null
              ]
            }
          },
          bottomRibbon
