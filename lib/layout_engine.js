      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '50px', top: '225px', width: '500px', height: '900px', display: 'flex', borderRadius: '250px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: isLightBg ? '#fcfcfc' : theme.bg1 },
              children: [
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', right: '50px', top: '225px', width: '500px', height: '900px', display: 'flex', borderRadius: '250px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: isLightBg ? '#fcfcfc' : theme.bg1 },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '500px', height: '900px', objectFit: 'cover' } } }
              ]
            } 
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', top: '150px', width: '850px', height: '550px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: isLightBg ? '#fcfcfc' : theme.bg1 },
              children: [
      ...
      props: {
        ...
        children: [
          ...
          { 
            type: 'div', 
            props: { 
              style: { position: 'absolute', left: '115px', bottom: '130px', width: '850px', height: '550px', display: 'flex', borderRadius: '275px', overflow: 'hidden', border: capsuleBorder, boxShadow: capsuleShadow, background: isLightBg ? '#fcfcfc' : theme.bg1 },
              children: [
                { type: 'img', props: { src: fgBase64, style: { width: '850px', height: '550px', objectFit: 'cover' } } }
              ]
            } 
