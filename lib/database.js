...
export async function cleanupOldHistory() {
  try {
    // ❌ USER REQUEST: Do NOT delete database history anymore! 
    // They want permanent history and media.
    console.log('[DB-Cleanup] Auto-cleanup disabled per user request. History will be kept permanently.');
    
    // await cleanupOldStorage(); // Supabase cleanup disabled as well
  } catch (e) {
