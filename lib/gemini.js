...
export async function generateThreadsContent(platform = 'threads', imageData = null, customPromptOverride = null) {
  ...
  const promptText = customPromptOverride || promptTextRow[0]?.value;
