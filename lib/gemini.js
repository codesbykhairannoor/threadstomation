...
- TONE: Technical, practical, peer-to-peer sharing. Disguise any promotion as a genuine tool recommendation.
    ...
    default:
      ...
      platformSpecificRules = `
- ANTI-AI STEALTH & HUMAN TONE: Write like a real, experienced human practitioner sharing authentic insights, NOT a marketing AI robot.
- ZERO AI CLICHES: Strictly FORBIDDEN to use: 'Delve', 'Tapestry', 'Game changer', 'In today's fast-paced world', 'Unlock the potential', 'Elevate', 'Look no further', 'Level up', 'Unleash', 'Crucial'.
- BURSTINESS & RHYTHM: Mix punchy 2-5 word statements with conversational thoughts. Keep phrasing natural, sharp, and easy to read on mobile.
- HOOK: Start with an intriguing real-world observation, counter-intuitive fact, or personal take.
- CONVERSATION DRIVER: Threads and IG algorithm prioritizes comments and reply depth. Always leave an unresolved question or provocative thought to invite readers to comment.
      `;
      break;
  }
...
- THREADS ALGORITHM & LINK RULE: External links kill organic reach on Threads. If a link is provided, place it ONLY at the end of the last reply of a multi-post thread (never in the first post). If single post, prefer saying 'Link in bio' or asking readers to comment to get the link.
- ENGAGEMENT ACCELERATOR (CRITICAL FOR THREADS): Threads prioritizes reply depth. Always end with an intriguing, controversial, or relatable open question that forces people to comment and debate.
${recentTopicsSection}
${platformSpecificRules}
